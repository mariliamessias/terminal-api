package com.rede.terminal_api.presentation.entrypoints;
...
import com.rede.terminal_api.presentation.entrypoints.request.CreateTerminalRequest;
import com.rede.terminal_api.presentation.entrypoints.response.CreateTerminalRequestResponse;
import com.rede.terminal_api.presentation.entrypoints.response.GetTerminalRequestResponse;
...
public class TerminalRequestController {
    ...
    public CreateTerminalRequestResponse create(@RequestBody CreateTerminalRequest request) {
